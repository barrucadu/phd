\todoinline{Discuss atomic-primops}
...
access to, \emph{and} no other thread has a reference to that
variable, \emph{then} the thread is deadlocked. This can easily be
extended to collections of threads which are all blocked on the same
variable.
