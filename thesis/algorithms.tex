\chapstart Not all algorithms are created equal.  When we impose bounds on
...
number of algorithms~\sref{algorithms-usual}, propose a new one based on a
\emph{weighted} random selection of threads~\sref{algorithms-swarm}, and show
