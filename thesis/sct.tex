...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption[How DPOR prunes the space of schedules.]{How DPOR prunes the space of schedules.  Transition $t_3$ is pruned in state $s_0$ because it is independent with transition $t_1$.}\label{fig:dpor}
\end{figure}
