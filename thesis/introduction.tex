...
\item \Cref{part:testing} is about \dejafu{}, our tool for testing
  concurrent Haskell programs.  \Cref{chp:dejafu} gives an account of
...
\item \Cref{part:properties} is about CoCo, our tool for discovering
  properties of concurrent functions.  \Cref{chp:coco} gives an
