...
\item \partref{testing} is about \dejafu{}, our tool for testing concurrent
  ...
  \chpref{algorithms} discusses an alternative scheduling algorithm for testing
  concurrent programs.
...
\item \partref{properties} is about CoCo, our tool for discovering properties of
  ...
  covering the scope, implementation, and some case studies.  Finally,
  \chpref{coco_and_dejafu} discusses using the properties discovered by CoCo as
  test cases in \dejafu{}.

\item Lastly, in \partref{end} we evaluate the work and discuss our conclusions
  in \chpref{conclusions} and suggest possible future work in
  \chpref{future_work}.
\end{itemize}
