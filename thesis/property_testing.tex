...
\textbf{Output}          &&&&&\\
~~generalized counterexamples            &\NN&\YY&\NN&\YN&\NN\\
\bottomrule
\multicolumn{6}{l}{
\footnotesize
Legend:\hspace{1em}
...
can generalise counter\-examples.  Generalising counterexamples
directly can be more efficient than a shrinking process as in
QuickCheck\cite{pike2014}.  Furthermore, it is often possible to
produce a generalisation which is simpler than any concrete
counterexample.  \Cref{lst:gencntr} shows such a generalised
