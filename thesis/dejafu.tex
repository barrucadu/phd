...
\Cref{sec:dejafu-testing}.  We use LeanCheck\cite{braquehais2017lean}
...
\item A copy of the \package{async} test suite, for our
...
also as example usages of \dejafu{}: the \package{auto-update} and
\textbf{Search
  Party}\footnote{\url{https://github.com/barrucadu/search-party}}
libraries, which we shall discuss in \Cref{sec:dejafu-casestudies};
the Dining Philosophers problem; a message queue; and an example of
testing typeclass laws using QuickCheck\cite{claessen2000} and
concurrency.
