...
abstracted form of our semantic rules, derived from version 0.9.0.0 of
\dejafu{}.
...
\multicolumn{2}{c}{\texttt{ActionName argument... c} \hfill \texttt{condition}} \\ \toprule
...
\Cref{fig:sem_notation} gives our notation for semantic rules.  This
...
There are two global values which are in scope for every rule:
...
semantic rules for \verb|ASub| and \verb|AStopSub|.  The \verb|ASub|
and \verb|AStopSub| actions implement a \dejafu{}-specific utility
function, and are not essential to the concurrency model.
...
\Cref{fig:sem_mvar1,fig:sem_mvar2} show the semantics for the
...
The \verb|wake| function unblocks all threads blocked on any of the
...
\Cref{fig:sem_cref1,fig:sem_cref2} show the semantics for the
...
\paragraph{Rules for miscellaneous actions}
\Cref{fig:sem_misc} shows the final few actions, which do not fit in
...
\multicolumn{2}{c}{\texttt{AFork act c}} \\ \toprule
...
\multicolumn{2}{c}{\texttt{AGetNumCapabilities c}} \\ \toprule
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{ASetNumCapabilities i c}} \\ \toprule
          \texttt{Caps :=} & \texttt{i} \\
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{AMyTId c}} \\ \toprule
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{AYield c}} \\ \toprule
\texttt{Threads[tid].K :=} & \texttt{c ()}
\end{tabular}
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{ADelay c}} \\ \toprule
\texttt{Threads[tid].K :=} & \texttt{c ()}
\end{tabular}
...
\footnotesize
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{ANewMVar c}} \\ \toprule
...
\multicolumn{2}{c}{\texttt{APutMVar (MVar id) \_ \_} \hfill \texttt{Heap[id] = Just \_}} \\ \toprule
              \texttt{Buffers :=} & \texttt{[]} \\
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{APutMVar (MVar id) a c} \hfill \texttt{Heap[id] = Nothing}} \\ \toprule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AReadMVar (MVar id) c} \hfill \texttt{Heap[id] = Just a}} \\ \toprule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AReadMVar (MVar id) \_} \hfill \texttt{Heap[id] = Nothing}} \\ \toprule
              \texttt{Buffers :=} & \texttt{[]} \\
                 \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
\texttt{Threads[tid].Blocking :=} & \texttt{[id]}
\end{tabular}
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATakeMVar (MVar id) c} \hfill \texttt{Heap[id] = Just a}} \\ \toprule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATakeMVar (MVar id) \_} \hfill \texttt{Heap[id] = Nothing}} \\ \toprule
              \texttt{Buffers :=} & \texttt{[]} \\
                 \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
\texttt{Threads[tid].Blocking :=} & \texttt{[id]}
\end{tabular}
...
\footnotesize
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATryPutMVar (MVar id) a c} \hfill \texttt{Heap[id] = Just \_}} \\ \toprule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATryPutMVar (MVar id) a c} \hfill \texttt{Heap[id] = Nothing}} \\ \toprule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATryReadMVar (MVar id) c} \hfill \texttt{Heap[id] = Just a}} \\ \toprule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATryReadMVar (MVar id) c} \hfill \texttt{Heap[id] = Nothing}} \\ \toprule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
...
\multicolumn{2}{c}{\texttt{ATryTakeMVar (MVar id) c} \hfill \texttt{Heap[id] = Just a}} \\ \toprule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{ATryTakeMVar (MVar id) c} \hfill \texttt{Heap[id] = Nothing}} \\ \toprule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
\texttt{Threads[tid].K :=} & \texttt{c Nothing}
\end{tabular}
...
\footnotesize
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{ANewCRef a c}} \\ \toprule
\texttt{let (idsrc, id) =} & \texttt{fresh IdSource} \\ \midrule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AReadCRef (CRef id) c} \hfill \texttt{buffered Buffers id = Just a}} \\ \toprule
\texttt{Threads[tid].K :=} & \texttt{c a}
\end{tabular}
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AReadCRef (CRef id) c} \hfill \texttt{buffered Buffers id = Nothing}} \\ \toprule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AReadCRefCAS (CRef id) c} \hfill \texttt{buffered Buffers id = Just a}} \\ \toprule
...
\begin{tabular}{R{4.5cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AReadCRefCAS (CRef id) c} \hfill \texttt{buffered Buffers id = Nothing}} \\ \toprule
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{AWriteCRef (CRef id) a c} \hfill \texttt{memtype = SequentialConsistency}} \\ \toprule
    \texttt{let (n, \_) =} & \texttt{Heap[id]} \\ \midrule
...
\multicolumn{2}{c}{\texttt{AModCRef (CRef id) f c}} \\ \toprule
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{4.5cm}}
\multicolumn{2}{c}{\texttt{AModCRefCAS (CRef id) f c}} \\ \toprule
       \texttt{let heap =} & \texttt{synchronise Heap Buffers} \\
     \texttt{let (n, a) =} & \texttt{heap[id]} \\ \midrule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{(heap[id] := (n + 1, f a))} \\
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{ACasCRef (CRef id) (Ticket id n \_) a c} \hfill \texttt{Heap[id] = (n, \_)}} \\ \toprule
       \texttt{let heap =} & \texttt{synchronise Heap Buffers} \\
    \texttt{let (n, \_) =} & \texttt{heap[id]} \\ \midrule
       \texttt{Buffers :=} & \texttt{[]} \\
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{ACasCRef (CRef id) (Ticket id n \_) \_ c} \hfill \texttt{Heap[id] /= (n, \_)}} \\ \toprule
       \texttt{let heap =} & \texttt{synchronise Heap Buffers} \\
     \texttt{let (n, a) =} & \texttt{heap[id]} \\ \midrule
       \texttt{Buffers :=} & \texttt{[]} \\
...
\multicolumn{2}{c}{\texttt{ACommit idT idC}} \\ \toprule
...
\end{tabular}
\caption{Small-step semantics of synchronised \texttt{CRef} actions.}\label{fig:sem_cref2}
\end{figure}
...
\footnotesize
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{AThrow e} \hfill \texttt{raise Threads[tid] e = (h:hs)}} \\ \toprule
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{AThrow e} \hfill \texttt{raise Threads[tid] e = []}} \\ \midrule
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{AThrowTo id e c}} \\
\multicolumn{2}{r}{\texttt{interruptible Threads[id] \&\& raise Threads[id] e = (h:hs)}} \\ \toprule
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{AThrowTo id e c}} \\
\multicolumn{2}{r}{\texttt{interruptible Threads[id] \&\& raise Threads[id] e = []}} \\ \toprule
...
\multicolumn{2}{c}{\texttt{AThrowTo id \_ \_} \hfill \texttt{¬ (interruptible Threads[id])}} \\ \toprule
\texttt{Threads[tid].Blocking :=} & \texttt{[id]}
\end{tabular}
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{ACatching h inner c}} \\ \toprule
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{APopCatching c}} \\ \toprule
...
\multicolumn{2}{c}{\texttt{AMasking m inner c}} \\ \toprule
...
\multicolumn{2}{c}{\texttt{AResetMask m c}} \\ \toprule
      \texttt{Threads[tid].K :=} & \texttt{c ()} \\
\texttt{Threads[tid].Masking :=} & \texttt{m}
\end{tabular}
...
\footnotesize
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{ALift n}} \\ \toprule
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{AReturn c}} \\ \toprule
\texttt{Threads[tid].K :=} & \texttt{c ()}
\end{tabular}
...
\multicolumn{2}{c}{\texttt{AStop n}} \\ \toprule
...
\Cref{fig:sem_aatom} shows the semantics for executing a transaction.
...
\footnotesize
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{AAtom stm c}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm = (Success a heap idsrc, \_, written)}} \\ \toprule
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{AAtom stm \_} \hfill \texttt{runSTM IdSource Heap stm = (Aborted, read, \_)}} \\ \toprule
   \texttt{Buffers :=} & \texttt{[]} \\
      \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{AAtom stm \_} \hfill \texttt{runSTM IdSource Heap stm = (Exception e, \_, \_)}} \\ \toprule
       \texttt{Buffers :=} & \texttt{[]} \\
          \texttt{Heap :=} & \texttt{synchronise Heap Buffers} \\
...
\footnotesize
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{SNew a c}} \\ \toprule
\texttt{let (idsrc, id) =} & \texttt{fresh IdSource} \\ \midrule
...
\multicolumn{2}{c}{\texttt{SRead (TVar id) c}} \\ \toprule
...
\begin{tabular}{R{2cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{SWrite (TVar id) a c}} \\ \toprule
\texttt{Heap[id] :=} & \texttt{a} \\
       \texttt{K :=} & \texttt{c ()} \\
...
\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{SRetry}} \\ \toprule
\end{tabular}

\vspace{1.5em}

\begin{tabular}{R{3cm}@{\hspace{0.5em}}L{3cm}}
\multicolumn{2}{c}{\texttt{SThrow e}} \\ \toprule
\end{tabular}

\vspace{1.5em}

\begin{tabular}{R{1.5cm}@{\hspace{0.5em}}L{1cm}}
\multicolumn{2}{c}{\texttt{SStop n}} \\ \toprule
\texttt{let \_ <-} & \texttt{n}
\end{tabular}
...
\footnotesize
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{SOrElse stm1 \_ c}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm1 = (Success a h i, r, w)}} \\ \toprule
    \texttt{Heap :=} & \texttt{h} \\
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{SOrElse stm1 \_ \_}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm1 = (Exception e, r, \_)}} \\ \toprule
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{SOrElse stm1 stm2 c}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm1 = (Aborted, r1, \_)}} \\
\multicolumn{2}{r}{\texttt{\&\& runSTM IdSource Heap stm2 = (Success a h i, r2, w)}} \\ \toprule
    \texttt{Heap :=} & \texttt{h} \\
\texttt{IdSource :=} & \texttt{i} \\
       \texttt{K :=} & \texttt{c a} \\
...
\multicolumn{2}{l}{\texttt{SOrElse stm1 stm2 c}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm1 = (Aborted, r1, \_)}} \\
\multicolumn{2}{r}{\texttt{\&\& runSTM IdSource Heap stm2 = (Aborted, r2, \_)}} \\ \toprule
...
\multicolumn{2}{l}{\texttt{SOrElse stm1 stm2 c}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm1 = (Aborted, r1, \_)}} \\
\multicolumn{2}{r}{\texttt{\&\& runSTM IdSource Heap stm2 = (Exception e, r2, \_)}} \\ \toprule
   \texttt{K :=} & \texttt{SThrow e} \\
\texttt{Read :=} & \texttt{r1 ++ r2 ++ Read}
\end{tabular}
\caption{Small-step semantics for the \texttt{SOrElse} action.}\label{fig:sem_stm2}
\end{figure}
...
\footnotesize
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{SCatch \_ stm c}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm = (Success a h i, r, w)}} \\ \toprule
    \texttt{Heap :=} & \texttt{h} \\
\texttt{IdSource :=} & \texttt{i} \\
       \texttt{K :=} & \texttt{c a} \\
    \texttt{Read :=} & \texttt{r ++ Read} \\
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{c}{\texttt{SCatch \_ stm \_} \hfill \texttt{runSTM IdSource Heap stm = (Aborted, r, \_)}} \\ \toprule
   \texttt{K :=} & \texttt{SRetry} \\
\texttt{Read :=} & \texttt{r ++ Read}
\end{tabular}
...
\begin{tabular}{R{5cm}@{\hspace{0.5em}}L{5cm}}
\multicolumn{2}{l}{\texttt{SCatch h stm \_}} \\
\multicolumn{2}{r}{\texttt{runSTM IdSource Heap stm = (Exception e, r, \_) \&\& handles h e}} \\ \toprule
   \texttt{K :=} & \texttt{h e} \\
\texttt{Read :=} & \texttt{r ++ Read}
\end{tabular}
...
dependency relation allows more precise decisions.  Our relation was
derived in part by running test cases.  This relation was derived in
part by running small test cases.
...
% [layout hack] push list to next page
\vfill
...
a \verb|DPOR| value is constructed, and abort if the state is invalid.
In the \dejafu{} testsuite, the time overhead of this checking is 3\%.
...
\begin{table}
  ...
  \end{subtable}
  \caption[Performance of the auto-update case study with multiple strategies.]{Performance of the auto-update case study with three different exploration tactics.  Swarm scheduling is a randomised approach discussed in \Cref{chp:algorithms}.}\label{tbl:autoupdate_perf}
\end{table}
