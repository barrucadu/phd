...
Case studies 1, 3, and 4 involve porting existing code to the
...
\Cref{lst:example-autoupdate1} shows how this race condition is
...
This deadlock may arise in any use of the library, as the occurrence
...
case study appears in \Cref{lst:example-searchparty0}.  One worker
...
\Cref{tbl:example-parmonad-diff} breaks down the changes across both
