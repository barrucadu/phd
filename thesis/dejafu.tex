...
reproduced in \lstref{example-autoupdate}.  The \verb|mkAutoUpdate|
...
\lstref{example-parmonad-sched} shows the original and converted
...
where the types have been changed.  \tblref{example-parmonad-diff}
