...
\newcommand{\semlrule}[1]{\langle\texttt{C}, \texttt{B}, \texttt{H}, \texttt{T}_{\left[\texttt{tid} \mapsto \langle\texttt{#1}, \texttt{E}, \texttt{M}\rangle\right]}\rangle}
...
\multicolumn{2}{l}{where \texttt{id} is fresh}\\
& \\
$\semlrule{APutMVar id a c}\rightarrow$&
...
& \\
$\semlrule{ATakeMVar id c}\rightarrow$&
...
& \\
$\semlrule{ATryPutMVar id a c}\rightarrow$&
...
\multicolumn{2}{l}{if $\texttt{H}_{[\texttt{id}]} = \texttt{Nothing}$}\\
& \\
$\semlrule{ATryTakeMVar id c}\rightarrow$\\
...
\multicolumn{2}{l}{if $\texttt{H}_{[\texttt{id}]} = \texttt{Nothing}$} \\
& \\
$\semlrule{ATryReadMVar id c}\rightarrow$&
