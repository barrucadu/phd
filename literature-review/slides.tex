...
\begin{frame}{Static Analysis}
  ...
  % "If P is any property possessed by some, but not all, recursively
  % enumerable sets, then there exists no effective general method for
  % deciding, given a set \alpha by means of a partial recursive
  % function enumerating it, whether or not \alpha has the property P"

  % Example of this by reduction to halting problem
