...
\begin{figure}[t]
  \centering
  \begin{ganttchart}[hgrid, vgrid, x unit=1cm,
    ...
    \ganttgroup{Testing}{1}{3} \\
    \ganttbar{Task A}{1}{3} \ganttnewline

    \ganttgroup{Verification}{3}{12} \\
    \ganttbar{Task B}{3}{5} \ganttnewline
    \ganttlinkedbar{Task C}{5}{6} \ganttnewline
    \ganttlinkedbar{Task D}{6}{12}
  \end{ganttchart}
