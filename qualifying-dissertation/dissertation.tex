...
\begin{tabularx}{\linewidth}{|XXX|}%
  \hline%
  \textbf{Dependencies:}   #1 &%
  \textbf{Related Aims:}   #2 &%
  \textbf{Aims Completed:} #3 \\%
  \textbf{Total Estimate:} #4 &%
  \textbf{Progress:}       #5 &\\%
  \hline%
\end{tabularx}}
\newcommand{\phas}[1]{\textbf{Phase #1}}
...
\vfill%
{\normalsize Number of words: 18,768 as counted by ``texcount -inc'',\\
